<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('agent.dashboard') }}">
        ...
        <div class="sidebar-brand-text mx-3">Vismo</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('agent.change.password') }}">Password Change</a>
                <a class="collapse-item" href="{{ route('agent.logout') }}">Logout</a>
            </div>
        </div>
    </li>
